...
if ($role === "Admin") {
    ...
    $cards = [
        ["title" => "ניהול קורסים", "desc" => "צפייה בקורסים, עדכון פרטים והגדרות.", "href" => "courseManagment.php"],
        ["title" => "רשימות סטודנטים", "desc" => "צפייה בסטודנטים הרשומים לקורסים שלך.", "href" => "studentsManagment.php"],
        ["title" => "בדיקת הרשמות", "desc" => "צפייה ורישום סטודנטים לקורסים.", "href" => "enroll.php"],
        ["title" => "דוחות קורס", "desc" => "סיכום הרשמות וסטטוסי סטודנטים.", "href" => "reports.php"],
    ];
} else { // Student
